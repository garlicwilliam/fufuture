...
export const BridgeAbi: any[] = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'srcAddr', type: 'address' },
      { indexed: false, internalType: 'bytes', name: 'dstAddr', type: 'bytes' },
      { indexed: false, internalType: 'uint256', name: 'etherAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'stoneAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'gasPaid', type: 'uint256' },
    ],
    name: 'BridgeTo',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: '_dstAddress', type: 'bytes' },
    ],
