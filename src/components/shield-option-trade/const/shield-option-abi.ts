    ...
    outputs: [
      {
        ...
        internalType: 'struct PerpetualOptions.MigrationDetail[]',
        name: 'info',
        type: 'tuple[]',
      },
    ],
